...
public class RedisUtil {
    ...
    private RedisUtil()  {
        if (pool == null) {
            ...
            String ip = propertiesUtil.readProperty("redis.urls");
            Integer port = Integer.valueOf(propertiesUtil.readProperty("redis.port"));
            String password = propertiesUtil.readProperty("redis.password");
            JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();
            jedisPoolConfig.setMaxTotal(Integer.valueOf(propertiesUtil.readProperty("redis.maxTotal")));
            jedisPoolConfig.setMaxIdle(Integer.valueOf(propertiesUtil.readProperty("redis.maxIdle")));
            jedisPoolConfig.setMaxWaitMillis(Long.valueOf(propertiesUtil.readProperty("redis.maxWaitMillis")));
            jedisPoolConfig.setTestOnBorrow(Boolean.valueOf(propertiesUtil.readProperty("redis.testOnBorrow")));
            jedisPoolConfig.setMinIdle(Integer.valueOf(propertiesUtil.readProperty("redis.minIdle")));
            Integer timeOut = Integer.valueOf(propertiesUtil.readProperty("redis.timeout"));
